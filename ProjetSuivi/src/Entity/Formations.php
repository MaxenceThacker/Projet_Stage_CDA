...
class Formations
{
    ...
    #[ORM\Column(type: 'date')]
    private $dateFinValdteAggrmtFormation;
    ...
    public function getDateFinValdteAggrmtFormation(): ?\DateTimeInterface
    {
        return $this->dateFinValdteAggrmtFormation;
    }

    public function setDateFinValdteAggrmtFormation(\DateTimeInterface $dateFinValdteAggrmtFormation): self
    {
        $this->dateFinValdteAggrmtFormation = $dateFinValdteAggrmtFormation;
